...
#define fxtran_acdc_stack_init(ydstack, ibl, nbl, ...) FXTRAN_ACDC_STACK_INIT ( YFXTRAN_ACDC_STACK, ibl, nbl, ##__VA_ARGS__)
...
#define fxtran_acdc_stack_alloc(n) CALL FXTRAN_ACDC_STACK_ALLOC (YLSTACK, IP_##n##_, SIZE (n, KIND=8), KIND (n))

#define fxtran_acdc_alloc4(n) IP_##n##_=YLSTACK%L4;YLSTACK%L4=YLSTACK%L4+4*SIZE(n,KIND=8);IF(YLSTACK%L4>YLSTACK%U4)
#define fxtran_acdc_alloc8(n) IP_##n##_=YLSTACK%L8;YLSTACK%L8=YLSTACK%L8+8*SIZE(n,KIND=8);IF(YLSTACK%L8>YLSTACK%U8)
