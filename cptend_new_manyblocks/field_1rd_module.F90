...
!need$ f1f294daf8252460 n field_1rd_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_1rd_host_alloc=>field_1rd_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_1rd_host_alloc_pooled=>field_1rd_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_1rd_host_dealloc=>field_1rd_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_1rd_host_dealloc_pooled=>field_1rd_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_1rd_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_1rd_host_alloc
private::host_alloc_module$host_alloc_module$field_1rd_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_1rd_host_dealloc
private::host_alloc_module$host_alloc_module$field_1rd_host_dealloc_pooled
type,abstract,extends(field_basic)::field_1rd
real(8),pointer::ptr(:)=>NULL()
real(8),pointer::devptr(:)=>NULL()
procedure(field_1rd_copy_intf),nopass,pointer::copy_func
contains
...
private::field_1rd_wrapper_init
private::field_1rd_owner_init
private::field_1rd_owner_create_host_data
private::field_1rd_delete_device_data
private::field_1rd_final
private::field_1rd_wrapper_final
private::field_1rd_owner_final
private::field_1rd_copy_object
private::field_1rd_wipe_object
private::field_1rd_copy_data
private::field_1rd_get_host_data
private::field_1rd_owner_get_host_data
private::field_1rd_get_host_data_rdonly
private::field_1rd_sync_host_rdonly
private::field_1rd_get_host_data_rdwr
private::field_1rd_sync_host_rdwr
private::field_1rd_create_device_data
private::field_1rd_get_device_data
private::field_1rd_crc64
private::field_1rd_owner_get_device_data
private::field_1rd_get_device_data_rdonly
private::field_1rd_get_device_data_wronly
private::field_1rd_sync_device_rdonly
private::field_1rd_get_device_data_rdwr
private::field_1rd_sync_device_rdwr
private::field_1rd_wrapper_get_dims
private::field_1rd_owner_get_dims
private::field_1rd_wrapper_resize
private::field_1rd_owner_resize
contains
...
function field_1rd_crc64(self) result(icrc)
class(field_1rd)::self
integer(8)::icrc
end
