...
private::field_2rm_new_owner
private::field_2rm_new_wrapper
private::field_2rm_delete
interface field_new
procedure::field_2rm_new_owner
procedure::field_2rm_new_wrapper
end interface
interface field_delete
procedure::field_2rm_delete
end interface
interface field_resize
procedure::field_2rm_resize
end interface
contains
subroutine field_2rm_new_owner(field_ptr,ubounds,lbounds,persistent,delayed,init_value,pinned,map_devptr,pooled)
class(field_2rm),pointer::field_ptr
integer(4),intent(in)::ubounds(1_8:2_8)
integer(4),intent(in),optional::lbounds(1_8:2_8)
logical(4),intent(in),optional::persistent
