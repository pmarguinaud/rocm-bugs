!mod$ v1 sum:9a640bd15e019689
!need$ d6b0ed10c6360817 n oml_mod
!need$ 186fc735db4ba7c3 i ieee_arithmetic
!need$ 027e02e1ec8ee360 n host_alloc_module
!need$ 6b828a5828583e97 n field_basic_module
!need$ acc15987a1e3d91c n field_defaults_module
!need$ 110fb82952e3aa1e n field_3im_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3im_host_alloc=>field_3im_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3im_host_alloc_pooled=>field_3im_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3im_host_dealloc=>field_3im_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3im_host_dealloc_pooled=>field_3im_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_3im_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_3im_host_alloc
private::host_alloc_module$host_alloc_module$field_3im_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_3im_host_dealloc
private::host_alloc_module$host_alloc_module$field_3im_host_dealloc_pooled
type,abstract,extends(field_basic)::field_3im
integer(4),pointer::ptr(:,:,:)=>NULL()
integer(4),pointer::devptr(:,:,:)=>NULL()
procedure(field_3im_copy_intf),nopass,pointer::copy_func
contains
...
integer(4),intent(out),optional::lbounds(1_8:3_8)
integer(4),intent(out),optional::ubounds(1_8:3_8)
end
end interface
private::resize
abstract interface
...
integer(4)::lbounds(1_8:3_8)
integer(4)::ubounds(1_8:3_8)
...
private::field_3im_wrapper_init
private::field_3im_owner_init
private::field_3im_owner_create_host_data
private::field_3im_get_view
private::field_3im_delete_device_data
private::field_3im_final
private::field_3im_wrapper_final
private::field_3im_owner_final
private::field_3im_copy_object
private::field_3im_wipe_object
private::field_3im_copy_data
private::field_3im_get_host_data
private::field_3im_owner_get_host_data
private::field_3im_get_host_data_rdonly
private::field_3im_sync_host_rdonly
private::field_3im_get_host_data_rdwr
private::field_3im_sync_host_rdwr
private::field_3im_create_device_data
private::field_3im_get_device_data
private::field_3im_crc64
private::field_3im_owner_get_device_data
private::field_3im_get_device_data_rdonly
private::field_3im_get_device_data_wronly
private::field_3im_sync_device_rdonly
private::field_3im_get_device_data_rdwr
private::field_3im_sync_device_rdwr
private::field_3im_wrapper_get_dims
private::field_3im_owner_get_dims
private::field_3im_wrapper_resize
private::field_3im_owner_resize
contains
...
integer(4),intent(inout),pointer::ptr(:,:,:)
integer(4),intent(in),optional::queue
end
...
class(field_3im)::self
integer(4),intent(inout),pointer::pptr(:,:,:)
integer(4),intent(in),optional::queue
end
...
function field_3im_crc64(self) result(icrc)
class(field_3im)::self
integer(8)::icrc
end
