...
!need$ 08200aaad0adab96 n field_3lm_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3lm_host_alloc=>field_3lm_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3lm_host_alloc_pooled=>field_3lm_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3lm_host_dealloc=>field_3lm_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_3lm_host_dealloc_pooled=>field_3lm_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_3lm_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_3lm_host_alloc
private::host_alloc_module$host_alloc_module$field_3lm_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_3lm_host_dealloc
private::host_alloc_module$host_alloc_module$field_3lm_host_dealloc_pooled
type,abstract,extends(field_basic)::field_3lm
logical(4),pointer::ptr(:,:,:)=>NULL()
logical(4),pointer::devptr(:,:,:)=>NULL()
procedure(field_3lm_copy_intf),nopass,pointer::copy_func
contains
...
private::field_3lm_wrapper_init
private::field_3lm_owner_init
private::field_3lm_owner_create_host_data
private::field_3lm_get_view
private::field_3lm_delete_device_data
private::field_3lm_final
private::field_3lm_wrapper_final
private::field_3lm_owner_final
private::field_3lm_copy_object
private::field_3lm_wipe_object
private::field_3lm_copy_data
private::field_3lm_get_host_data
private::field_3lm_owner_get_host_data
private::field_3lm_get_host_data_rdonly
private::field_3lm_sync_host_rdonly
private::field_3lm_get_host_data_rdwr
private::field_3lm_sync_host_rdwr
private::field_3lm_create_device_data
private::field_3lm_get_device_data
private::field_3lm_crc64
private::field_3lm_owner_get_device_data
private::field_3lm_get_device_data_rdonly
private::field_3lm_get_device_data_wronly
private::field_3lm_sync_device_rdonly
private::field_3lm_get_device_data_rdwr
private::field_3lm_sync_device_rdwr
private::field_3lm_wrapper_get_dims
private::field_3lm_owner_get_dims
private::field_3lm_wrapper_resize
private::field_3lm_owner_resize
contains
...
function field_3lm_crc64(self) result(icrc)
class(field_3lm)::self
integer(8)::icrc
end
