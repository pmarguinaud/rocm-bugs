...
!need$ 0dc48ed717c2a042 n field_4lm_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_4lm_host_alloc=>field_4lm_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_4lm_host_alloc_pooled=>field_4lm_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_4lm_host_dealloc=>field_4lm_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_4lm_host_dealloc_pooled=>field_4lm_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_4lm_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_4lm_host_alloc
private::host_alloc_module$host_alloc_module$field_4lm_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_4lm_host_dealloc
private::host_alloc_module$host_alloc_module$field_4lm_host_dealloc_pooled
type,abstract,extends(field_basic)::field_4lm
logical(4),pointer::ptr(:,:,:,:)=>NULL()
logical(4),pointer::devptr(:,:,:,:)=>NULL()
procedure(field_4lm_copy_intf),nopass,pointer::copy_func
contains
...
private::field_4lm_wrapper_init
private::field_4lm_owner_init
private::field_4lm_owner_create_host_data
private::field_4lm_get_view
private::field_4lm_delete_device_data
private::field_4lm_final
private::field_4lm_wrapper_final
private::field_4lm_owner_final
private::field_4lm_copy_object
private::field_4lm_wipe_object
private::field_4lm_copy_data
private::field_4lm_get_host_data
private::field_4lm_owner_get_host_data
private::field_4lm_get_host_data_rdonly
private::field_4lm_sync_host_rdonly
private::field_4lm_get_host_data_rdwr
private::field_4lm_sync_host_rdwr
private::field_4lm_create_device_data
private::field_4lm_get_device_data
private::field_4lm_crc64
private::field_4lm_owner_get_device_data
private::field_4lm_get_device_data_rdonly
private::field_4lm_get_device_data_wronly
private::field_4lm_sync_device_rdonly
private::field_4lm_get_device_data_rdwr
private::field_4lm_sync_device_rdwr
private::field_4lm_wrapper_get_dims
private::field_4lm_owner_get_dims
private::field_4lm_wrapper_resize
private::field_4lm_owner_resize
contains
...
function field_4lm_crc64(self) result(icrc)
class(field_4lm)::self
integer(8)::icrc
end
