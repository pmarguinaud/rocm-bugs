...
!need$ 404b5e5b6be8a930 n field_5im_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5im_host_alloc=>field_5im_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5im_host_alloc_pooled=>field_5im_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5im_host_dealloc=>field_5im_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5im_host_dealloc_pooled=>field_5im_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_5im_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_5im_host_alloc
private::host_alloc_module$host_alloc_module$field_5im_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_5im_host_dealloc
private::host_alloc_module$host_alloc_module$field_5im_host_dealloc_pooled
type,abstract,extends(field_basic)::field_5im
integer(4),pointer::ptr(:,:,:,:,:)=>NULL()
integer(4),pointer::devptr(:,:,:,:,:)=>NULL()
procedure(field_5im_copy_intf),nopass,pointer::copy_func
contains
...
integer(4),intent(out),optional::lbounds(1_8:5_8)
integer(4),intent(out),optional::ubounds(1_8:5_8)
end
end interface
private::resize
abstract interface
...
integer(4)::lbounds(1_8:5_8)
integer(4)::ubounds(1_8:5_8)
...
private::field_5im_wrapper_init
private::field_5im_owner_init
private::field_5im_owner_create_host_data
private::field_5im_get_view
private::field_5im_delete_device_data
private::field_5im_final
private::field_5im_wrapper_final
private::field_5im_owner_final
private::field_5im_copy_object
private::field_5im_wipe_object
private::field_5im_copy_data
private::field_5im_get_host_data
private::field_5im_owner_get_host_data
private::field_5im_get_host_data_rdonly
private::field_5im_sync_host_rdonly
private::field_5im_get_host_data_rdwr
private::field_5im_sync_host_rdwr
private::field_5im_create_device_data
private::field_5im_get_device_data
private::field_5im_crc64
private::field_5im_owner_get_device_data
private::field_5im_get_device_data_rdonly
private::field_5im_get_device_data_wronly
private::field_5im_sync_device_rdonly
private::field_5im_get_device_data_rdwr
private::field_5im_sync_device_rdwr
private::field_5im_wrapper_get_dims
private::field_5im_owner_get_dims
private::field_5im_wrapper_resize
private::field_5im_owner_resize
contains
...
function field_5im_crc64(self) result(icrc)
class(field_5im)::self
integer(8)::icrc
end
