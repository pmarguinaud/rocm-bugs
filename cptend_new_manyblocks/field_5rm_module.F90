...
!need$ 126ddbfe1f0aac49 n field_5rm_data_module
...
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5rm_host_alloc=>field_5rm_host_alloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5rm_host_alloc_pooled=>field_5rm_host_alloc_pooled
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5rm_host_dealloc=>field_5rm_host_dealloc
use host_alloc_module,only:host_alloc_module$host_alloc_module$field_5rm_host_dealloc_pooled=>field_5rm_host_dealloc_pooled
private::oml_max_threads
private::oml_my_thread
private::ieee_signaling_nan
private::field_5rm_copy_intf
private::jprm
private::jprd
private::jpim
private::jplm
...
private::nf2l
private::nl2f
private::host_alloc_module$host_alloc_module$field_5rm_host_alloc
private::host_alloc_module$host_alloc_module$field_5rm_host_alloc_pooled
private::host_alloc_module$host_alloc_module$field_5rm_host_dealloc
private::host_alloc_module$host_alloc_module$field_5rm_host_dealloc_pooled
type,abstract,extends(field_basic)::field_5rm
real(4),pointer::ptr(:,:,:,:,:)=>NULL()
real(4),pointer::devptr(:,:,:,:,:)=>NULL()
procedure(field_5rm_copy_intf),nopass,pointer::copy_func
contains
...
private::field_5rm_wrapper_init
private::field_5rm_owner_init
private::field_5rm_owner_create_host_data
private::field_5rm_get_view
private::field_5rm_delete_device_data
private::field_5rm_final
private::field_5rm_wrapper_final
private::field_5rm_owner_final
private::field_5rm_copy_object
private::field_5rm_wipe_object
private::field_5rm_copy_data
private::field_5rm_get_host_data
private::field_5rm_owner_get_host_data
private::field_5rm_get_host_data_rdonly
private::field_5rm_sync_host_rdonly
private::field_5rm_get_host_data_rdwr
private::field_5rm_sync_host_rdwr
private::field_5rm_create_device_data
private::field_5rm_get_device_data
private::field_5rm_crc64
private::field_5rm_owner_get_device_data
private::field_5rm_get_device_data_rdonly
private::field_5rm_get_device_data_wronly
private::field_5rm_sync_device_rdonly
private::field_5rm_get_device_data_rdwr
private::field_5rm_sync_device_rdwr
private::field_5rm_wrapper_get_dims
private::field_5rm_owner_get_dims
private::field_5rm_wrapper_resize
private::field_5rm_owner_resize
contains
...
real(4),intent(inout),pointer::ptr(:,:,:,:,:)
integer(4),intent(in),optional::queue
end
...
class(field_5rm)::self
real(4),intent(inout),pointer::pptr(:,:,:,:,:)
integer(4),intent(in),optional::queue
end
...
function field_5rm_crc64(self) result(icrc)
class(field_5rm)::self
integer(8)::icrc
end
