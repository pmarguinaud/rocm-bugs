...
use oml_mod,only:oml_destroy_lock
use oml_mod,only:oml_test_event
use oml_mod,only:oml_wait_event
use oml_mod,only:oml_set_event
use oml_mod,only:oml_incr_event
use oml_mod,only:oml_incr_counter
...
private::oml_debug
private::oml_lock_kind
private::oml_set_num_threads
private::oml_get_max_threads
private::oml_init
private::oml_omp
private::oml_in_parallel
private::oml_test_lock
private::oml_unset_lock
private::oml_set_lock
private::oml_init_lock
private::oml_destroy_lock
private::oml_test_event
private::oml_wait_event
private::oml_set_event
private::oml_incr_event
private::oml_incr_counter
private::oml_my_thread
private::oml_max_threads
private::oml_get_num_threads
integer(4),private,save::mab_cnt
contains
subroutine mpl_abort(cdmessage)
character(*,1),intent(in),optional::cdmessage
end
end
