...
private::mpl_allgatherv_real4
private::mpl_allgatherv_real8
private::mpl_allgatherv_int
private::mpl_allgatherv_int_scalar
interface mpl_allgatherv
procedure::mpl_allgatherv_real8
procedure::mpl_allgatherv_real4
procedure::mpl_allgatherv_int
procedure::mpl_allgatherv_int_scalar
end interface
contains
subroutine mpl_allgatherv_real4(psendbuf,precvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
real(4)::psendbuf(:)
real(4)::precvbuf(:)
...
subroutine mpl_allgatherv_real8(psendbuf,precvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
real(8)::psendbuf(:)
real(8)::precvbuf(:)
integer(4),intent(in)::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
...
subroutine mpl_allgatherv_int(ksendbuf,krecvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
integer(4)::ksendbuf(:)
integer(4)::krecvbuf(:)
integer(4),intent(in)::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
...
subroutine mpl_allgatherv_int_scalar(ksendbuf,krecvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
integer(4)::ksendbuf
integer(4)::krecvbuf(:)
