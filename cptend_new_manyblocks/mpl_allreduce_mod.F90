...
use mpl_broadcast_mod,only:mpl_broadcast_mod$mpl_broadcast_mod$mpl_broadcast_real4=>mpl_broadcast_real4
use mpl_broadcast_mod,only:mpl_broadcast_mod$mpl_broadcast_mod$mpl_broadcast_real8=>mpl_broadcast_real8
use mpl_recv_mod,only:mpl_recv_mod$mpl_recv_mod$mpl_recv_real4=>mpl_recv_real4
use mpl_recv_mod,only:mpl_recv_mod$mpl_recv_mod$mpl_recv_real8=>mpl_recv_real8
use mpl_send_mod,only:mpl_send_mod$mpl_send_mod$mpl_send_real4=>mpl_send_real4
use mpl_send_mod,only:mpl_send_mod$mpl_send_mod$mpl_send_real8=>mpl_send_real8
use mpl_wait_mod,only:mpl_wait_mod$mpl_wait_mod$mpl_waits=>mpl_waits
private::jprd
private::jpim
private::jprm
private::jpib
...
private::mpl_broadcast_mod$mpl_broadcast_mod$mpl_broadcast_real4
private::mpl_broadcast_mod$mpl_broadcast_mod$mpl_broadcast_real8
private::mpl_recv_mod$mpl_recv_mod$mpl_recv_real4
private::mpl_recv_mod$mpl_recv_mod$mpl_recv_real8
private::mpl_send_mod$mpl_send_mod$mpl_send_real4
private::mpl_send_mod$mpl_send_mod$mpl_send_real8
private::mpl_wait_mod$mpl_wait_mod$mpl_waits
logical(4),private::llabort
private::mpl_allreduce_int_scalar
private::mpl_allreduce_int8_scalar
private::mpl_allreduce_real8_scalar
private::mpl_allreduce_real4_scalar
private::mpl_allreduce_int
private::mpl_allreduce_int8
private::mpl_allreduce_real8
private::mpl_allreduce_real8_2d
private::mpl_allreduce_real4
private::mpl_allreduce_real4_2d
interface mpl_allreduce
procedure::mpl_allreduce_real8
procedure::mpl_allreduce_real4
procedure::mpl_allreduce_int
procedure::mpl_allreduce_int8
procedure::mpl_allreduce_real8_scalar
procedure::mpl_allreduce_real4_scalar
procedure::mpl_allreduce_int_scalar
procedure::mpl_allreduce_int8_scalar
procedure::mpl_allreduce_real4_2d
procedure::mpl_allreduce_real8_2d
end interface
contains
subroutine mpl_allreduce_int_scalar(ksendbuf,cdoper,ldreprod,kcomm,kerror,cdstring)
integer(4),intent(inout)::ksendbuf
character(*,1),intent(in)::cdoper
logical(4),intent(in),optional::ldreprod
...
integer(8),intent(inout)::ksendbuf
character(*,1),intent(in)::cdoper
logical(4),intent(in),optional::ldreprod
integer(4),intent(in),optional::kcomm
integer(4),intent(out),optional::kerror
...
subroutine mpl_allreduce_real8_2d(psendbuf,cdoper,ldreprod,kcomm,kerror,cdstring)
real(8),intent(inout)::psendbuf(:,:)
character(*,1),intent(in)::cdoper
logical(4),intent(in),optional::ldreprod
integer(4),intent(in),optional::kcomm
...
subroutine mpl_allreduce_real4_2d(psendbuf,cdoper,ldreprod,kcomm,kerror,cdstring)
real(4),intent(inout)::psendbuf(:,:)
character(*,1),intent(in)::cdoper
logical(4),intent(in),optional::ldreprod
integer(4),intent(in),optional::kcomm
