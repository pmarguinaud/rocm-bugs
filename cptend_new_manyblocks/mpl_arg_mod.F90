...
character(10_4,1),private,save::cl_terminate
integer(4),parameter,private::jp_arglen=1024_4
character(1024_4,1),allocatable,private,save::cl_args(:)
integer(4),private,save::n_args
private::init_args
contains
subroutine mpl_arg_set_cl_terminate(cdterm)
character(*,1),intent(in)::cdterm
end
subroutine mpl_arg_get_cl_terminate(cdterm)
character(*,1),intent(out)::cdterm
end
subroutine init_args()
end
subroutine mpl_getarg(karg,cdarg)
integer(4),intent(in)::karg
character(*,1),intent(out)::cdarg
end
