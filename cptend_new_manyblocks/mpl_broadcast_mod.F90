...
private::mpl_broadcast_preamb1
private::mpl_broadcast_real4
private::mpl_broadcast_real8
private::mpl_broadcast_real42
private::mpl_broadcast_real43
private::mpl_broadcast_real44
private::mpl_broadcast_real82
private::mpl_broadcast_real83
private::mpl_broadcast_real84
private::mpl_broadcast_real4_scalar
private::mpl_broadcast_real8_scalar
private::mpl_broadcast_int
private::mpl_broadcast_int2
private::mpl_broadcast_int3
private::mpl_broadcast_int_scalar
private::mpl_broadcast_char_scalar
private::mpl_broadcast_char1
private::mpl_broadcast_logical_scalar
private::mpl_broadcast_logical1
interface mpl_broadcast
procedure::mpl_broadcast_real4
procedure::mpl_broadcast_real8
procedure::mpl_broadcast_real42
procedure::mpl_broadcast_real43
procedure::mpl_broadcast_real44
procedure::mpl_broadcast_real82
procedure::mpl_broadcast_real83
procedure::mpl_broadcast_real84
procedure::mpl_broadcast_real4_scalar
procedure::mpl_broadcast_real8_scalar
procedure::mpl_broadcast_int
procedure::mpl_broadcast_int2
procedure::mpl_broadcast_int3
procedure::mpl_broadcast_int_scalar
procedure::mpl_broadcast_char_scalar
procedure::mpl_broadcast_char1
procedure::mpl_broadcast_logical_scalar
procedure::mpl_broadcast_logical1
end interface
contains
subroutine mpl_broadcast_preamb1(krootr,kcommr,kpl_numproc,kpl_myrank,kmp_typer,ldreturn,kerror,kcomm,kroot,kmp_type)
integer(4),intent(out)::krootr
integer(4),intent(out)::kcommr
integer(4),intent(out)::kpl_numproc
integer(4),intent(out)::kpl_myrank
integer(4),intent(out)::kmp_typer
logical(4),intent(out)::ldreturn
