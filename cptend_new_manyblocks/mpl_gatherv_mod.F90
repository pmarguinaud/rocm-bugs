...
!need$ 12ac395bea9063cb n mpl_stats_mod
!need$ cca5f10dff6b21ee n yommplstats
...
use mpl_stats_mod,only:mpl_statson
use mpl_stats_mod,only:mpl_statsread
use mpl_stats_mod,only:mpl_sendstats
use mpl_stats_mod,only:mpl_recvstats
use yommplstats,only:lmplstats
use yommplstats,only:mplsendbytes
use yommplstats,only:mplrecvbytes
use yommplstats,only:mplsendnum
use yommplstats,only:mplrecvnum
...
private::mpl_statsinit
private::mpl_statson
private::mpl_statsread
private::mpl_sendstats
private::mpl_recvstats
private::lmplstats
private::mplsendbytes
private::mplrecvbytes
private::mplsendnum
private::mplrecvnum
private::mpl_message
private::mpl_send
...
real(8),private::zdum_jprd
real(4),private::zdum_jprm
integer(4),private::zdum_int
private::mpl_gatherv_preamb1
private::mpl_gatherv_preamb2
private::mpl_gatherv_real4
private::mpl_gatherv_real8
private::mpl_gatherv_char_scalar
private::mpl_gatherv_int
private::mpl_gatherv_int_scalar
private::mpl_gatherv_real8_scalar
interface mpl_gatherv
procedure::mpl_gatherv_real8
procedure::mpl_gatherv_real4
procedure::mpl_gatherv_char_scalar
procedure::mpl_gatherv_int
procedure::mpl_gatherv_int_scalar
end interface
contains
...
integer(4),intent(out)::ipl_numproc
integer(4),intent(out)::ipl_myrank
integer(4),intent(out)::icomm
integer(4),intent(out)::iroot
integer(4),intent(out)::imp_type
integer(4),intent(in),optional::kcomm
integer(4),intent(in),optional::kroot
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::krequest
end
...
integer(4),intent(in)::ipl_numproc
integer(4),intent(in)::ipl_myrank
integer(4),intent(in)::irecvbufsize
integer(4),intent(in)::isendcount
integer(4),intent(in)::krecvcounts(:)
integer(4),intent(out)::kirecvdispl(:)
integer(4),intent(in),optional::krecvdispl(:)
character(*,1),intent(in),optional::cdstring
end
subroutine mpl_gatherv_real4(psendbuf,kroot,precvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
real(4),intent(in)::psendbuf(:)
integer(4),intent(in),optional::kroot
real(4),intent(out),optional::precvbuf(:)
integer(4),intent(in),optional::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
integer(4),intent(in),optional::krecvdispl(:)
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
integer(4),intent(out),optional::kerror
integer(4),intent(out),optional::krequest
character(*,1),intent(in),optional::cdstring
end
subroutine mpl_gatherv_real8(psendbuf,kroot,precvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
real(8)::psendbuf(:)
integer(4),intent(in),optional::kroot
real(8),optional::precvbuf(:)
integer(4),intent(in),optional::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
integer(4),intent(in),optional::krecvdispl(:)
integer(4),intent(in),optional::kmp_type
...
subroutine mpl_gatherv_char_scalar(csendbuf,kroot,crecvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
character(*,1)::csendbuf
integer(4),intent(in),optional::kroot
character(*,1),optional::crecvbuf(:)
integer(4),intent(in),optional::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
integer(4),intent(in),optional::krecvdispl(:)
integer(4),intent(in),optional::kmp_type
...
subroutine mpl_gatherv_int(ksendbuf,kroot,krecvbuf,krecvcounts,ksendcount,krecvdispl,kmp_type,kcomm,kerror,krequest,cdstring)
integer(4),intent(in)::ksendbuf(:)
integer(4),intent(in),optional::kroot
integer(4),intent(out),optional::krecvbuf(:)
integer(4),intent(in)::krecvcounts(:)
integer(4),intent(in),optional::ksendcount
integer(4),intent(in),optional::krecvdispl(:)
integer(4),intent(in),optional::kmp_type
...
subroutine mpl_gatherv_int_scalar(ksendbuf,kroot,krecvbuf,krecvcounts,ksendcount,kmp_type,krecvdispl,kcomm,kerror,krequest,cdstring)
integer(4),intent(in)::ksendbuf
integer(4),intent(in),optional::kroot
integer(4),intent(out),optional::krecvbuf(:)
integer(4),intent(in),optional::krecvcounts(:)
...
real(8),intent(in)::psendbuf
integer(4),intent(in),optional::kroot
real(8),intent(out),optional::precvbuf(:)
integer(4),intent(in),optional::krecvcounts(:)
integer(4),intent(in),optional::krecvdispl(:)
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
