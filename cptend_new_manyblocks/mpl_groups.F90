...
private::mpl_message
integer(4)::mpl_comm_grid
integer(4)::mpl_all_levs_comm
integer(4)::mpl_all_ms_comm
integer(4),private::mpl_gp_grid
logical(4),private,save::lgroupsetup
contains
subroutine mpl_groups_create(kprocw,kprocv)
integer(4),intent(in)::kprocw
integer(4),intent(in)::kprocv
end
function mpl_cart_rank(kprocw,kprocv)
integer(4),intent(in)::kprocw
integer(4),intent(in)::kprocv
integer(4)::mpl_cart_rank
end
subroutine mpl_cart_coords(kproc,kprocw,kprocv)
integer(4),intent(in)::kproc
integer(4),intent(out)::kprocw
integer(4),intent(out)::kprocv
end
end
