...
!need$ ea2fa40af8c59281 n ec_env_mod
...
use ec_env_mod,only:ec_numenv
use ec_env_mod,only:ec_environ
...
use oml_mod,only:oml_mod$oml_mod$oml_max_threads=>oml_max_threads
private::jpim
private::oml_init
...
integer(4),intent(in),optional::koutput
integer(4),intent(in),optional::kunit
integer(4),intent(out),optional::kerror
integer(4),intent(out),optional::kprocs
logical(4),intent(in),optional::ldinfo
logical(4),intent(in),optional::ldenv
end
end
