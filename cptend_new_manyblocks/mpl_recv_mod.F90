...
private::mpl_message
private::mpl_nproc
private::mpl_recv_preamb
private::mpl_recv_tail
private::mpl_recv_real4
private::mpl_recv_real8
private::mpl_recv_int
private::mpl_recv_int8
private::mpl_recv_int2
private::mpl_recv_int_scalar
private::mpl_recv_real4_scalar
private::mpl_recv_real8_scalar
private::mpl_recv_real42
private::mpl_recv_real43
private::mpl_recv_real82
private::mpl_recv_real83
private::mpl_recv_char_scalar
private::mpl_recv_char
interface mpl_recv
procedure::mpl_recv_real4
procedure::mpl_recv_real8
procedure::mpl_recv_int
procedure::mpl_recv_real42
procedure::mpl_recv_real43
procedure::mpl_recv_real82
procedure::mpl_recv_real83
procedure::mpl_recv_int_scalar
procedure::mpl_recv_int2
procedure::mpl_recv_real4_scalar
procedure::mpl_recv_real8_scalar
procedure::mpl_recv_char_scalar
procedure::mpl_recv_int8
procedure::mpl_recv_char
end interface
contains
...
integer(4),intent(out)::ksourcer
integer(4),intent(out)::ktagr
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
integer(4),intent(in),optional::ksource
integer(4),intent(in),optional::ktag
integer(4),optional::krequest
end
subroutine mpl_recv_tail(krecv_status,ktype,kfrom,kount,krecvtag,kerror,cdstring)
integer(4),intent(in)::krecv_status(1_8:6_8)
integer(4),intent(in)::ktype
integer(4),intent(out),optional::kfrom
integer(4),intent(out),optional::kount
integer(4),intent(out),optional::krecvtag
