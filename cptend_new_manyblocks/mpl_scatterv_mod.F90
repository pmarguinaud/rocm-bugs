...
integer(4),private::iroot
integer(4),private::ipl_numproc
integer(4),private::irecvcount
integer(4),private::isendbufsize
integer(4),private::ir
integer(4),private::ipl_myrank
integer(4),private::imp_type
logical(4),private::llabort
integer(4),private::ierror
integer(4),private::idum
real(8),private::zdum
real(4),private::zdum_4
integer(4),private::zdum_int
private::mpl_scatterv_preamb1
private::mpl_scatterv_preamb2
private::mpl_scatterv_real8
private::mpl_scatterv_real4
private::mpl_scatterv_integer
interface mpl_scatterv
procedure::mpl_scatterv_real8
procedure::mpl_scatterv_real4
procedure::mpl_scatterv_integer
end interface
contains
...
integer(4),intent(in)::ksendcounts(:)
integer(4),intent(out)::kisenddispl(:)
integer(4),intent(in),optional::ksenddispl(:)
...
real(8),intent(out)::precvbuf(:)
integer(4),intent(in)::kroot
real(8),intent(in),optional::psendbuf(:)
integer(4),intent(in),optional::ksendcounts(:)
integer(4),intent(in),optional::ksenddispl(:)
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
...
real(4),intent(out)::precvbuf(:)
integer(4),intent(in)::kroot
real(4),intent(in),optional::psendbuf(:)
integer(4),intent(in),optional::ksendcounts(:)
integer(4),intent(in),optional::ksenddispl(:)
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
...
integer(4),intent(out)::krecvbuf(:)
integer(4),intent(in)::kroot
integer(4),intent(in),optional::ksendbuf(:)
integer(4),intent(in),optional::ksendcounts(:)
integer(4),intent(in),optional::ksenddispl(:)
integer(4),intent(in),optional::kmp_type
integer(4),intent(in),optional::kcomm
