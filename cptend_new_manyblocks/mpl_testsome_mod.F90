...
private::mpl_message
contains
subroutine mpl_testsome(karray_of_requests,karray_of_indices,karray_of_indices1,koutcount,koutcount1,kerror,cdstring,ldwait)
integer(4),intent(in)::karray_of_requests(:)
integer(4),intent(out)::karray_of_indices(:)
integer(4),intent(out),optional::karray_of_indices1(:)
integer(4),intent(out),optional::koutcount
integer(4),intent(out),optional::koutcount1
integer(4),intent(out),optional::kerror
character(*,1),intent(in),optional::cdstring
logical(4),intent(in),optional::ldwait
end
end
