...
private::mpl_comm_io
private::mpl_ioinit
private::mpl_write_int
private::mpl_write_real8
interface mpl_write
procedure::mpl_write_int
procedure::mpl_write_real8
end interface
contains
subroutine mpl_write_int(kfptr,kop,kbuf,klen,kreq,kerror)
integer(4),intent(in)::kfptr
integer(4),intent(in)::kop
integer(4)::kbuf(:)
integer(4),intent(in)::klen
integer(4)::kreq
