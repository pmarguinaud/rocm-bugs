...
logical(4),optional,pointer::hst(:,:,:,:)
logical(4),optional,pointer::dev(:,:,:,:)
...
function field_4lm_get_last_contiguous_dimension(ptr,after) result(jdim)
logical(4),pointer::ptr(:,:,:,:)
integer(4)::after
integer(4)::jdim
end
end
