...
real(8),optional,pointer::hst(:,:,:,:,:)
real(8),optional,pointer::dev(:,:,:,:,:)
...
function field_5rd_get_last_contiguous_dimension(ptr,after) result(jdim)
real(8),pointer::ptr(:,:,:,:,:)
integer(4)::after
integer(4)::jdim
end
